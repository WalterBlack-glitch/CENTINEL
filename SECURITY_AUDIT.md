# Auditoría de Seguridad — Centinel
...
**Archivo:** `centinel/correlation/engine.py:47, 56`
...
**Archivo:** `centinel/collectors/authlog.py:16-26, 56-81`
...
**Archivo:** `centinel/collectors/authlog.py:16-26`
...
**Archivo:** `centinel/app.py:25-69`; `centinel/collectors/sniffer.py:44`
...
**Archivo:** `centinel/presentation/terminal.py:66-93, 96-106`; alimentado por `enrichment/resolver.py:115` (rDNS) y username de `authlog.py`
...
**Archivo:** `centinel/enrichment/resolver.py:33, 118`
...
**Archivo:** `centinel/enrichment/resolver.py:102`
...
**Archivo:** `centinel/enrichment/resolver.py:76-82`
...
**Archivo:** `centinel/storage/db.py:52-71`
...
**Archivo:** `centinel/collectors/authlog.py:18,21,25`; `enrichment/resolver.py:24`
...
**Archivo:** `centinel/collectors/authlog.py:83-105`
...
**Archivo:** `centinel/core.py:62-72`
...
**Archivo:** `centinel/collectors/authlog.py:38-46`

`os.path.exists` seguido de `open` más tarde: ventana TOCTOU para symlink swap del log. Como corre como root, un symlink colocado por un local hacia un archivo sensible podría hacer que Centinel lo lea/tail. Riesgo bajo (requiere control del directorio del log).
